...
public class ESStructurePoolElementTypes {
	...
	public static final RegistryObject<StructurePoolElementType<?>, StructurePoolElementType<ESSinglePoolElement>> SINGLE_POOL = STRUCTURE_POOL_ELEMENT_TYPES.register("single_pool", () -> ESSinglePoolElement.CODEC::codec);
