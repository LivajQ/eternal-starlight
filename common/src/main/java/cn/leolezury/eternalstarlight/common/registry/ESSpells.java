...
public class ESSpells {
	...
	public static final Codec<AbstractSpell> CODEC = ResourceLocation.CODEC.xmap(SPELLS::get, SPELLS::getId);
	public static final Codec<Holder<AbstractSpell>> HOLDER_CODEC = ResourceLocation.CODEC.xmap(id -> Holder.direct(SPELLS.get(id)), holder -> SPELLS.getId(holder.value()));
