...
public record GatheringTrailParticleOptions(ParticleType<GatheringTrailParticleOptions> type, float trailWidth, float trailLength, float speedScale, float rotSpeedScale) implements ParticleOptions {
	...
	public static GatheringTrailParticleOptions energy() {
		return new GatheringTrailParticleOptions(
			ESParticles.GATHERING_ENERGY.get(),
			0.125f,
			5,
			1.25f,
			0.25f
	...
	public static GatheringTrailParticleOptions soul() {
		return new GatheringTrailParticleOptions(
			ESParticles.GATHERING_SOUL.get(),
			0.125f,
			3,
			1.25f,
			1.25f
	...
	public static GatheringTrailParticleOptions soulThin() {
		return new GatheringTrailParticleOptions(
			ESParticles.GATHERING_SOUL.get(),
			0.06f,
			2,
	...
	public static GatheringTrailParticleOptions flare() {
		return new GatheringTrailParticleOptions(
			ESParticles.GATHERING_FLARE.get(),
			0.125f,
			2,
			1f,
			1f
