...
public class ESWeathers {
	...
	public static final Codec<AbstractWeather> CODEC = ResourceLocation.CODEC.xmap(WEATHERS::get, WEATHERS::getId);

	public static final RegistryObject<AbstractWeather, MeteorShowerWeather> METEOR_SHOWER =
		WEATHERS.register("meteor_shower", () ->
			new MeteorShowerWeather(
				new AbstractWeather.Properties(
					UniformInt.of(1200, 2400),
					UniformInt.of(36000, 180000)
				)
			)
		);

	public static final RegistryObject<AbstractWeather, EmptyWeather> AURORA =
		WEATHERS.register("aurora", () ->
			new EmptyWeather(
				new AbstractWeather.Properties(
					UniformInt.of(6000, 12000),
					UniformInt.of(36000, 180000)
				)
			)
		);
