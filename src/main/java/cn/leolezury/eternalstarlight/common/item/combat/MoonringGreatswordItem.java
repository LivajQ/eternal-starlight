...
public class MoonringGreatswordItem extends GreatswordItem {
	...
	public MoonringGreatswordItem(Tier tier, int damage, float speed, float reach, Properties props) {
