...
public class ESForgeItemStackRenderer extends BlockEntityWithoutLevelRenderer {
	public static final Supplier<ESForgeItemStackRenderer> INSTANCE = Suppliers.memoize(ESForgeItemStackRenderer::new);
	...
	public ESForgeItemStackRenderer() {
