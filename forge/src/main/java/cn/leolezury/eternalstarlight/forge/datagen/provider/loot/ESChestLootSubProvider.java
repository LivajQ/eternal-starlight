			...
			LootTable.lootTable()
				...
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(Items.BOOK).apply(new EnchantRandomlyFunction.Builder()
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.FEARLESS.getId())))
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.PRECISION.getId())))
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.HOMING.getId())))
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.GATHERING.getId())))).setWeight(25))
				...
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(Items.BOOK).apply(new EnchantRandomlyFunction.Builder()
						...
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.PRECISION.getId())))
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.HOMING.getId())))
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.GATHERING.getId())))).setWeight(75))
		...
		consumer.accept(ESLootTables.CHEST_CURSED_GARDEN,
			LootTable.lootTable()
				...
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(Items.BOOK).apply(new EnchantRandomlyFunction.Builder()
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.FEARLESS.getId())))
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.POISONING.getId())))
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.SOUL_SNATCHER.getId())))
						.withEnchantment(Objects.requireNonNull(BuiltInRegistries.ENCHANTMENT.get(ESEnchantments.TRACING.getId())))).setWeight(40))
